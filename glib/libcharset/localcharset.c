...
_g_locale_get_charset_aliases (void)
{
  ...
  if (cp == NULL)
    {
#if !(defined VMS || defined WIN32_NATIVE || defined __CYGWIN__ || defined OS2)
      FILE *fp;
      const char *dir;
...
# if defined OS2
      ...
      /* Please keep this code in sync with gettext sources:
         http://trac.netlabs.org/ports/browser/gettext/trunk/gettext-runtime/intl/localcharset.c
      */
